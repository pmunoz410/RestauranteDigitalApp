package com.project.restaurantedigitalapp.adapter;
...
public class CategoriaAdapter extends ArrayAdapter<Categoria> {
    private final String url = ConfigApi.baseUrl + "/api/documento-almacenado/download/";
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        if(convertView == null){
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.items_categorias, parent, false);
        }
        ...
        Picasso picasso = new Picasso.Builder(convertView.getContext())
                ...
                .build();
        picasso.load(url + c.getDocumentoAlmacenado().getFileName())
